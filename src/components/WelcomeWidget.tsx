...
export default function WelcomeWidget() {
  return (
    <section className="bg-primary-container text-on-primary-container rounded-2xl p-8 relative overflow-hidden border-2 border-primary shadow-lg min-h-[280px] flex flex-col justify-between">
      ...
      <div className="relative z-10 w-full">
        <button className="w-full sm:w-auto bg-surface-container-lowest text-primary hover:bg-surface border-2 border-transparent hover:border-primary font-label-lg text-label-lg font-bold py-4 px-8 rounded-xl transition-all shadow-md active:scale-95 min-h-[56px]">
          Sign Up Today
        </button>
      </div>
